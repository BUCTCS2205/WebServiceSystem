...
<template>
  ...
  <div class="login-box">
    <div class="login-banner">
      <img src="https://ts4.tc.mm.bing.net/th/id/OIP-C.sxyResvi0UJ8JSGrt9zfDgHaGa?w=268&h=232&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2" class="absolute inset-s-4 inset-t-4 h-8 rounded">
      <img src="https://ts3.tc.mm.bing.net/th/id/OIP-C.xd-cqTMnKzoR-x5qNbcAjgHaHa?w=250&h=250&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2" class="banner">
    </div>
